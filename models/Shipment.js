...
const shipmentSchema = mongoose.Schema({
    ...
    ref_1: {type: String, required: false}, // business id1 of the multi-parcel package
    ref_2: {type: String, required: false}, // business id2 of the multi-parcel package
    ref_3: {type: String, required: false}, // business id3 of the multi-parcel package
